...
-- beautiful.init(awful.util.get_themes_dir() .. "k-theme/theme.lua")
beautiful.init(awful.util.getdir("config") .. "/themes/k-theme/theme.lua")

beautiful.init("~/.config/awesome/themes/k-theme/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    --awful.tag({ "web", "mail", "3", "4", "5" }, s, awful.layout.layouts[1])
...
awful.util.spawn_with_shell("urxvt -name mutt -e mutt")
-- awful.util.spawn_with_shell("xterm -e mutt")
-- awful.util.spawn_with_shell("emacs --insecure")
